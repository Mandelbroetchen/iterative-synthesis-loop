...
files = {
    "prompt-final/document.md": """# Freefall of an Apple - Physics Simulation
...
class PhysicsEngine:
    ...
    def update_physics(self, time_step):
        ...
        if self.environment.air_resistance_enabled:
            ...
            drag_magnitude = 0.5 * self.environment.air_density * \
                            velocity.magnitude()**2 * \
                            self.apple.drag_coefficient * \
                            self.apple.cross_sectional_area
...
""",
    "prompt-final/usecase-diagram.uml": """@startuml FreefallUseCaseDiagram
...
@enduml
""",
    "prompt-final/package-diagram.uml": """@startuml FreefallPackageDiagram
...
@enduml
""",
    "prompt-final/class-diagram.uml": """@startuml FreefallClassDiagram
